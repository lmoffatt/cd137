...
{   Treatment  med;
    ...
    /*4*/ sp.IFN_APCbo_prod_rate_=1e-10;
    ...
    /*8*/ sp.percentage_IFN_APC0_prod_rate_=0.01;
    /*9*/ sp.percentage_IFN_APCa_prod_rate_=0.01;
    /*10*/ sp.percentage_IFN_APCbo_prod_rate_=0.01;

    /// 5)Percentages of TNF productions of each type of APC
    /*11*/ sp.percentage_TNF_APC0_prod_rate_=0.01;
    /*12*/ sp.percentage_TNF_APCa_prod_rate_=0.01;
    /*13*/ sp.percentage_TNF_APCbo_prod_rate_=0.01;
    ...
    /*3*/  sp.IFN_NKa_prod_rate_=1e-10;
    /*4*/  sp.IFN_NKbo_prod_rate_=1e-10;
