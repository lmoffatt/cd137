...
void NK_cells::update(double time_step,const Media& m,const APC_cells& APC, const LT_cells& LT)
{
    ...
    NK_num_LT_bound_d+=NK_num_Ag_d*time_step*NK_free_to_bound_rate_per_LT_d*LT.num_cells_expressing_receptor_and_free()+
                       NK_num_Ag_d*time_step*NK_free_to_bound_rate_per_LT_d*APC.num_Ag()+
                       NK_num_Ag_d*time_step*NK_free_to_bound_rate_per_LT_d*NK_num_Ag_d+
